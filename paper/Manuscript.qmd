...
ham_city_bound <- st_read(paste0(here::here(),"/data-prep/data-inputs/Boundaries/City_Boundary.shp")) |> st_transform(st_crs(cen_data_2011_hamiltononly))
ham_community_bounds <- st_read(paste0(here::here(),"/data-prep/data-inputs/Boundaries/Community_Boundaries.shp")) |> st_transform(st_crs(cen_data_2011_hamiltononly))
```
...
ggh_taz <- st_read(paste0(here::here(), "/data-prep/data-inputs/TTS/tts06_83_region.shp")) %>% st_transform(crs = 32617)
