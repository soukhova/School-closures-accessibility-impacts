...
```{r}
RED_LU_centroids_2011 <- sp::over(as_Spatial(st_centroid(RED_LU_2011)),as_Spatial(cen_data_2011_1 |> select(GeoUID)))
RED_LU_centroids_2011<- cbind(RED_LU_centroids_2011,st_centroid(RED_LU_2011))
```
```{r}
