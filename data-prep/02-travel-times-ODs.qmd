...
load(file = "data-inputs/Parcels/RED_LU_centroids_2021.Rdata")
```

Format the destination points (ID, Long, Lat):
```{r}
Dest_all_schools_elem_2011 <- cbind(as.data.frame(SCHOOLS), st_coordinates(st_transform(SCHOOLS, crs = 4326))) %>% filter(Level == "Elementary" & (Year == "2011" | Year == "2011 and 2016")) %>%
  rename(lon = "X", lat = "Y", id = "SchoolID") %>%
  select(id, lon, lat)

Dest_all_schools_elem_2016 <- cbind(as.data.frame(SCHOOLS), st_coordinates(st_transform(SCHOOLS, crs = 4326))) %>% filter(Level == "Elementary" & (Year == "2016" | Year == "2011 and 2016")) %>%
  rename(lon = "X", lat = "Y", id = "SchoolID") %>%
  select(id, lon, lat)

Dest_all_schools_elem_2021 <- cbind(as.data.frame(SCHOOLS), st_coordinates(st_transform(SCHOOLS, crs = 4326))) %>% filter(Level == "Elementary" & (Year_2 == "2021" | Year_2 == "2016 and 2021")) %>%
  rename(lon = "X", lat = "Y", id = "SchoolID") %>%
  select(id, lon, lat)
```
...
Orig_all_2021 <- cbind(RED_LU_centroids_2021,
                       st_coordinates(st_transform(RED_LU_centroids_2021 |> st_as_sf(), crs = 4326))) %>%
  rename(lon = X, lat = Y, id = ID) %>%
  select(id, lon, lat)
```
...
```{r}
Orig_all_2021_1 <- Orig_all_2021[1:36903,]
Orig_all_2021_2 <- Orig_all_2021[36904:73807,]
Orig_all_2021_3 <- Orig_all_2021[73808:110710,]
Orig_all_2021_4 <- Orig_all_2021[110711:143890,]
```
...
r5_HAM <- setup_r5(data_path = r5_path, verbose = TRUE,  temp_dir = TRUE)#, overwrite = TRUE)
```
...
## 2021 car travel times:
```{r}
# set up batching according to how many origin rows to process at one time
chunksize = 50 
num_chunks = ceiling(nrow(Orig_all_2021_1)/chunksize)

# create origin-destination pairs
origins_chunks <- as.disk.frame(Orig_all_2021_1,
                          outdir = "data-inputs/Travel-times/Processing/Orig",
                          nchunks = num_chunks,
                          overwrite = TRUE)
...
for (i in 1:num_chunks){
  ...
  ttm_chunk <- travel_time_matrix(r5r_core = r5_HAM,
                          origins = Orig_chunk,
                          destinations = Dest_all_schools_elem_2021,
                          mode = c("CAR"), 
                          departure_datetime = as.POSIXct(strptime("2021-03-01 08:00:00", "%Y-%m-%d %H:%M:%S", tz = "EST5EDT")),
                          max_trip_duration = 90)
...
save("output_OD_car1", file = "data-products/OD_tt_car_2021_1.Rdata")
rm("output_OD_car1")
```
...
# set up batching according to how many origin rows to process at one time
chunksize = 50 
num_chunks = ceiling(nrow(Orig_all_2021_2)/chunksize)

# create origin-destination pairs
origins_chunks <- as.disk.frame(Orig_all_2021_2,
                          outdir = "data-inputs/Travel-times/Processing/Orig",
                          nchunks = num_chunks,
                          overwrite = TRUE)
...
save("output_OD_car2", file = "data-products/OD_tt_car_2021_2.Rdata")
rm("output_OD_car2")
```
...
# set up batching according to how many origin rows to process at one time
chunksize = 50 
num_chunks = ceiling(nrow(Orig_all_2021_3)/chunksize)

# create origin-destination pairs
origins_chunks <- as.disk.frame(Orig_all_2021_3,
                          outdir = "data-inputs/Travel-times/Processing/Orig",
                          nchunks = num_chunks,
                          overwrite = TRUE)
...
save("output_OD_car3", file = "data-products/OD_tt_car_2021_3.Rdata")
rm("output_OD_car3")
```
...
# set up batching according to how many origin rows to process at one time
chunksize = 50 
num_chunks = ceiling(nrow(Orig_all_2021_4)/chunksize)

# create origin-destination pairs
origins_chunks <- as.disk.frame(Orig_all_2021_4,
                          outdir = "data-inputs/Travel-times/Processing/Orig",
                          nchunks = num_chunks,
                          overwrite = TRUE)
...
save("output_OD_car4", file = "data-products/OD_tt_car_2021_4.Rdata")
rm("output_OD_car4")
```
...
save("output_OD_walk_elem1", file = "data-products/OD_tt_walk_2021_1.Rdata")
rm("output_OD_walk_elem1")
...
save("output_OD_walk_elem2", file = "data-products/OD_tt_walk_2021_2.Rdata")
rm("output_OD_walk_elem2")
...
save("output_OD_walk_elem3", file = "data-products/OD_tt_walk_2021_3.Rdata")
rm("output_OD_walk_elem3")
...
save("output_OD_walk_elem4", file = "data-products/OD_tt_walk_2021_4.Rdata")
rm("output_OD_walk_elem4")
```
