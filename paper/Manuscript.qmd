...
SCHOOLS_nochangeorexpanded <- SCHOOLS |> filter(Year == "2011 and 2016" & Year_2 == "2016 and 2021") |> 
  mutate(Year = ifelse(Year == "2011 and 2016", "2011", Year))
ALL_SCHOOLS_Elem_formapping <- rbind(SCHOOLS, SCHOOLS_nochangeorexpanded)
rm(SCHOOLS_nochangeorexpanded)
...
# tdata_hux[2,1:12] <- c("", "% {\\Delta}", "" , "% {\\Delta}", "", "% {\\Delta}Δ", "", "% ${\\Delta}", "", "% {\\Delta}", "", "% {\\Delta}")
